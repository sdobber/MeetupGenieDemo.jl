...
# !!! Main.UserApp is configured as an alias for Main.MeetupGenieDemo and you might encounter it in some tests
using Main.MeetupGenieDemo, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MeetupGenieDemo tests" begin
  @includetests ARGS
end
